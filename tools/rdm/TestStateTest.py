...
class TestStateCmpTest(unittest.TestCase):
  ...
  def testCmp(self):
    ...
    states = sorted([TestState.PASSED, TestState.FAILED, TestState.BROKEN, TestState.NOT_RUN])
    self.assertEqual(states,
                              [TestState.BROKEN, TestState.FAILED, TestState.NOT_RUN, TestState.PASSED])
